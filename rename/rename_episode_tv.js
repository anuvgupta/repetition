...
// arg 2 = directory of files to rename (must have same number of files as map entries. helps if you have file format title "S##E##" ie. S02E05.mkv)
// arg 3 = which position in the episode file name the number is at (optional, default = 4)
// arg 4 = how many digits are in the episode number (optional, default = 2)
...
var num_start = args.length >= 3 ? parseInt(args[3]) : 4;
var num_digits = args.length >= 4 ? parseInt(args[4]) : 2;
